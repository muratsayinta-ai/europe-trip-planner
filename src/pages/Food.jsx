...
export default function Food() {
  const { cities, restaurants, places, itinerary, addRestaurant, updateRestaurant, deleteRestaurant, dateForDay } = useData()
            ...
            return (
              <div key={d.day} className="food-day-group">
                <div className="food-day-head">
                  ...
                  {dateForDay(d.day) && <span className="food-day-date">{fmtDayDate(dateForDay(d.day))}</span>}
